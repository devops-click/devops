...
curl -sL https://raw.githubusercontent.com/devops-click/devops/main/configs/apps/nginx-edge/etc/nginx/nginx.conf.template -o /etc/nginx/nginx.conf.template
