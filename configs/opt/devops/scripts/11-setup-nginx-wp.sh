...
curl -sL https://raw.githubusercontent.com/devops-click/devops/main/configs/apps/wordpress/etc/nginx/snippets/converter-for-media.conf -o /etc/nginx/snippets/converter-for-media.conf
...
curl -sL https://raw.githubusercontent.com/devops-click/devops/main/configs/apps/wordpress/etc/nginx/snippets/wordpress-defaults.conf -o /etc/nginx/snippets/wordpress-defaults.conf
...
curl -sL https://raw.githubusercontent.com/devops-click/devops/main/configs/apps/wordpress/etc/php-fpm.d/www.conf -o /etc/php-fpm.d/www.conf
